...
function x(t, n) {
  return Promise.resolve().then(function () {
    return t.status !== v
      ? t
      : (R || (window.dispatchEvent(new o("single-spa:before-first-mount")), (R = !0)),
        V(t, "mount")
          .then(function () {
...
function k(e) {
  ...
  var i = S({}, o, { name: r, mountParcel: W.bind(e), singleSpa: t });
...
function F(t, n, e) {
  ...
  K.bootstrap = { millis: t, dieOnTimeout: n, warningMillis: e || 1e3 };
}
function J(t, n, e) {
  if ("number" != typeof t || t <= 0) throw Error(s(17, !1));
  K.mount = { millis: t, dieOnTimeout: n, warningMillis: e || 1e3 };
}
function H(t, n, e) {
  if ("number" != typeof t || t <= 0) throw Error(s(18, !1));
  K.unmount = { millis: t, dieOnTimeout: n, warningMillis: e || 1e3 };
}
function Q(t, n, e) {
  if ("number" != typeof t || t <= 0) throw Error(s(19, !1));
  K.unload = { millis: t, dieOnTimeout: n, warningMillis: e || 1e3 };
}
function V(t, n) {
  var e = t.timeouts[n],
    r = e.warningMillis,
  ...
  return new Promise(function (i, u) {
    ...
    function l(t) {
      if (!a)
        if (!0 === t) (c = !0), e.dieOnTimeout ? u(Error(f)) : console.error(f);
        else if (!c) {
          var n = t,
            o = n * r;
          console.warn(f),
      ...
      : ((t.status = p),
        (t.loadPromise = Promise.resolve()
          .then(function () {
            ...
            return o.then(function (r) {
              ...
              (t.loadErrorTime = null),
                "object" !== n((e = r)) && (o = 34),
                Object.prototype.hasOwnProperty.call(e, "bootstrap") && !D(e.bootstrap) && (o = 35),
                D(e.mount) || (o = 36),
                D(e.unmount) || (o = 37);
              var i = N(e);
              if (o) {
              ...
              return (
                e.devtools &&
                  e.devtools.overlays &&
                  (t.devtools.overlays = S({}, t.devtools.overlays, e.devtools.overlays)),
                (t.status = h),
                (t.bootstrap = U(e, "bootstrap")),
                (t.mount = U(e, "mount")),
                (t.unmount = U(e, "unmount")),
                (t.unload = U(e, "unload")),
                (t.timeouts = q(e.timeouts)),
          ...
          .catch(function (n) {
            var e;
            return (
              delete t.loadPromise, r ? (e = P) : ((e = y), (t.loadErrorTime = new Date().getTime())), u(n, t, e), t
            );
          })));
    var e, r;
  });
...
if (Y) {
  ...
  (window.addEventListener = function (t, n) {
    if (
      !("function" == typeof n && tt.indexOf(t) >= 0) ||
      _(Z[t], function (t) {
        return t === n;
      })
    )
    ...
    (window.history.pushState = ot(window.history.pushState, "pushState")),
    (window.history.replaceState = ot(window.history.replaceState, "replaceState")),
    window.singleSpaNavigate ? console.warn(s(41, !1)) : (window.singleSpaNavigate = nt);
}
function ct(t) {
...
function vt(t, n, e, r) {
  (pt[T(t)] = { app: t, resolve: e, reject: r }), Object.defineProperty(pt[T(t)], "promise", { get: n });
}
function dt(t) {
  return pt[t];
}
...
function Ot(t, e, r, o) {
  ...
  wt.push(
    S({ loadErrorTime: null, status: l, parcels: {}, devtools: { overlays: { options: {}, selectors: [] } } }, i)
  ),
    Y && (ft(), Lt());
}
function bt() {
...
function Lt() {
  ...
  if (Dt)
    return new Promise(function (t, e) {
      Ut.push({ resolve: t, reject: e, eventArguments: n });
    });
  var r,
    i = gt(),
    u = i.appsToUnload,
    ...
    return Promise.resolve().then(function () {
      if (
        (window.dispatchEvent(
          new o(0 === r.length ? "single-spa:before-no-app-change" : "single-spa:before-app-change", O(!0))
        ),
        window.dispatchEvent(new o("single-spa:before-routing-event", O(!0, { cancelNavigation: m }))),
        f)
      )
        return window.dispatchEvent(new o("single-spa:before-mount-routing-event", O(!0))), E(), void nt(p);
      var n = u.map(ht),
        e = a
          .map(L)
          .map(function (t) {
...
export {
  ...
  l as NOT_LOADED,
  v as NOT_MOUNTED,
  P as SKIP_BECAUSE_BROKEN,
  E as UNMOUNTING,
  g as UPDATING,
  a as addErrorHandler,
  bt as checkActivityFunctions,
  ft as ensureJQuerySupport,
  yt as getAppNames,
  Pt as getAppStatus,
  Et as getMountedApps,
  C as mountRootParcel,
  nt as navigateToUrl,
  _t as pathToActiveWhen,
  Ot as registerApplication,
  c as removeErrorHandler,
  F as setBootstrapMaxTime,
  J as setMountMaxTime,
  Q as setUnloadMaxTime,
  H as setUnmountMaxTime,
  xt as start,
  Mt as triggerAppChange,
  At as unloadApplication,
  Tt as unregisterApplication,
};
